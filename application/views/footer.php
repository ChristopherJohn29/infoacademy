<footer class="footer">
    <div class="footer_background" style="background-image:url(<?php echo base_url() . '/assets/unicat/images/' ?>footer_background.png)"></div>
    <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-3 footer_col">
                            ...
                            <div class="footer_section footer_about">
                                <div class="footer_logo_container">
                                    <a href="#">
                                        <div class="footer_logo_text">Info<span>Academy</span></div>
                                    </a>
                                </div>
                        ...
                        <div class="col-lg-3 footer_col">
                            ...
                            <div class="footer_section footer_links">
                                <div class="footer_title">Terms of use</div>

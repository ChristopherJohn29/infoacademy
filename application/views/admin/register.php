        ...
        <div class="card-body register-card-body">
            <form action="<?php echo base_url() . '/control/registersubmit' ?>" method="post">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="*Region" required="required"
                           name="office_region">
                    <input type="text" class="form-control" placeholder="*City / Municipality" required="required"
                           name="office_city">
                    <input type="text" class="form-control" placeholder="*Barangay" required="required"
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="*Mobile number" required="required"
                           name="mobile_number">
                    <input type="text" class="form-control" placeholder="*Telephone number" required="required"
